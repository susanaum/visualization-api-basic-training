module.exports = {
  ...
  path_of_plugins: '/Applications/MicroStrategy Workstation.app/Contents/Frameworks/OneTierDashboardWindow.framework/Versions/A/Resources/code/plugins',
  ...
  summary: 'Simple Bar Chart', // default value of viz summary string defined in i18n message bundle.
  use_case: 'Represent KPI value per attribute element', // default value of viz use case string defined in i18n message bundle.
  requirements: 'Uses 1 ##attributes and 1 ##metric', // default value of viz requirements string defined in i18n message bundle.
